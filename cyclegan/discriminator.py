...
class CNN_Discriminator_Img(BasicBlock):
    def __init__(self, class_num=None, name=None):
        super(CNN_Discriminator_Img, self).__init__(None, name or "Discriminator_CNN")
...
class CNN_Discriminator_Seq(BasicBlock):
    '''
        x: 4d tensor. [N, T, d, C]
    ...
    '''
    def __init__(self, class_num=None, name=None):
        super(CNN_Discriminator_Seq, self).__init__(None, name or "D")
        self.class_num = class_num
